...
CREATE TRIGGER trg_conversations_updated_at
    ...
    FOR EACH ROW EXECUTE FUNCTION touch_updated_at();
-- Mirror of infrastructure/db/schema.sql (fresh-DB bootstrap before migrations 002-011).
-- Both must stay in sync; migrate.mjs applies this file first when the DB is empty.
